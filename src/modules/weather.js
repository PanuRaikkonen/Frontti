...
// Haetaan säätiedot openweathermapin api:sta käyttämällä Arabian kampuksen koordinaatteja. Käytetään suomenkielistä dataa ja metrijärjestelmää.
fetch(
  ...
  .then((data) => {
    ...
    // Syötetään säätiedot html-tiedostoon.
